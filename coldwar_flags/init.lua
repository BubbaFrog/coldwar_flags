----------------------------------------------------------
-- Minetest :: coldwaric Flags Mod (coldwar_flags)
--
-- See README.txt for licensing and other information
-- Code adapted from "pride_flags" mod by Leslie E. Krause
-- Copyright (c) 2022, BubbaFrog
--
-- ./games/minetest_game/mods/coldwar_flags/init.lua
----------------------------------------------------------
...
local flag_list = { "usa",   "antisoviet", "srussia", "vietnam", "eastgermany", "westgermany", "sukraine", "cambodia", "namwarveteran", "cuba",}
...
minetest.register_entity( "coldwar_flags:wavingflag", {
	initial_properties = {
		...
		pointable = false,
		mesh = "wavingflag.b3d",
		textures = { string.format( "coldwar_flags_%s.png", flag_list[1] ) },
...
print( cur_wind )
	...
	reset_texture = function ( self, flag_idx )
		...
		local texture = string.format( "coldwar_flags_%s.png", flag_list[ self.flag_idx ] )
