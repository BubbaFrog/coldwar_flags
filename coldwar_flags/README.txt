ColdWar Flags Mod v1.0
By BubbaFrog, adapted from the prideflags mod by Leslie E. Krause


  /giveme coldwar_flags:mast_lower
  /giveme coldwar_flags:mast_upper

By default, The "Better Dead The Red" flag will appear when the upper mast is placed because by default the first flag is american stuff
